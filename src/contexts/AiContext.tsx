...
export type ImageProvider = 'gemini-imagen' | 'huggingface' | 'pollinations-flux' | 'pollinations-schnell' | 'pollinations-turbo' | 'pollinations-klein' | 'wan2.1-t2i-plus' | 'qwen-image-2.0-pro' | 'qwen-image-2512';
...
const VALID_IMAGE: ImageProvider[] = ['gemini-imagen', 'huggingface', 'pollinations-flux', 'pollinations-schnell', 'pollinations-turbo', 'pollinations-klein', 'wan2.1-t2i-plus', 'qwen-image-2.0-pro', 'qwen-image-2512'];
