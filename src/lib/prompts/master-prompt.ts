...
- Include formal assessment header: Type (Test/Project/Assignment/PAT/Exam), Duration, Total Marks, Date, CAPS Reference.
...
- Include POPIA notice in EVERY document footer: "Confidential — This document may contain information protected under POPIA (Act 4 of 2013). Handle in accordance with data protection principles. Generated by EduAI Companion — 2026."
...
- SA BRANDING: 6px flag stripe gradient header (black→gold→green→white→red→blue), school header with DBE branding, compliance stamps (✅ CAPS Aligned #007749, ✅ NPA Compliant #002395, ✅ POPIA Compliant #000000, ✅ SIAS Inclusive #FFB81C, ✅ WP6 Differentiated), POPIA footer, 2026 year.
...
- If user requests **HTML**: Output a complete standalone HTML5 document with Tailwind CSS via CDN. Include beautiful @media print styles. MUST include: SA flag stripe (6px gradient), school header (DBE branded with EMIS, district, province), CAPS reference bar, compliance stamps (CAPS, NPA, POPIA, SIAS, WP6), differentiation boxes, SIAS support box, NPA 7-point table, Bloom's tags, POPIA footer with 2026.
...
- NEVER generate your own page-level Header/Footer bars, logos, or watermarks: the app automatically wraps your output in the official EduAI LIGHT Template v4 chrome (solid white header, watermark, navy footer). Keep compliance content (POPIA notice, compliance stamps, SA flag stripe) INSIDE the content cards below.
...
- Output an HTML FRAGMENT (body content only — NEVER <html>/<head>/<body>). Structure it with LIGHT cards so it renders natively in the template:
  <article class="card"><h1 class="lesson-title">[Title]</h1><div class="lesson-meta"><span class="meta-pill">Grade X</span><span class="meta-pill">[Subject]</span><span class="meta-pill">Term Y</span><span class="meta-pill">CAPS Aligned</span></div><p>…intro…</p></article>
...
Poster / Wall Chart: A3/A2/A1 portrait, 300 DPI, SA flag stripe header, SA-inspired textured background, one breathtaking central Disney 3D illustration (diverse SA learners, rainbow nation, Table Mountain/Kruger/protea/Rand context), 4–6 fact boxes with Bloom's tags, Montserrat Black titles, Open Sans/Poppins 24pt body, SA coat of arms discreetly, compliance stamps (CAPS, NPA, POPIA, SIAS, WP6), differentiation hint, SIAS box, POPIA footer 2026.
Worksheet: Hero illustration 25–30% top (Qwen-Image SA context), SA flag stripe, school header, CAPS reference bar, Score box, Name/Date, Bloom's tagged questions with marks visible, differentiation boxes (Core green #007749, Extended blue #002395, Simplified gold #FFB81C), SIAS support box gold, NPA 7-point table, compliance stamps, POPIA footer 2026, 2–3 spot illustrations throughout.
Infographic / Mind Map: Central concept with radiating branches, each branch custom illustrated icon (Qwen-Image SA), color-coded SA case studies, flat design with subtle depth, Bloom's tags, SA flag stripe, compliance stamps.
...
Assessment / Test: Formal header (type, duration, marks, date 2026, CAPS ref), instructions, Bloom's + marks per question, SA context (Rand, SA places/names), differentiation, SIAS accommodations, NPA table, memorandum with marking guidelines, rubric 7-point scale, POPIA notice.
Lesson Plan: 5 phases (Introduction, Development, Consolidation, Assessment, Reflection), CAPS ref, ATP week, duration, objectives (Bloom's), resources, differentiation (Core/Extended/Simplified), SIAS notes, assessment, homework, reflection, SA context, IKS, ubuntu values, compliance stamps.
...
Admin Document: Official header (SA flag stripe, school info, EMIS, district, province — Qwen image), REF, Date 2026, Recipient, Subject, Body, Reply slip, Signatures (Teacher/Principal/SGB placeholders), Distribution, POPIA confidentiality notice, footer 2026.
