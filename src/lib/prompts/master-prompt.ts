...
- NEVER generate your own page-level Header/Footer bars, logos, or watermarks: the app automatically wraps your output in the official EduAI LIGHT Template v4 chrome (translucent header, watermark, navy footer). Keep compliance content (POPIA notice, compliance stamps, SA flag stripe) INSIDE the content cards below.
