...
export default function App() {
  ...
  const getCategoryForTab = (tabId: string, role: string | null) => {
    ...
    if (tabId === 'weekly-planner' || tabId === 'planner' || tabId === 'curriculum') return 'curriculum-planning';
    if (tabId === 'learner-intervention') return 'class-management';
    if (['teaching', 'visual', 'video', 'admin', 'grade1', 'archive'].includes(tabId)) return 'lesson-planning';
