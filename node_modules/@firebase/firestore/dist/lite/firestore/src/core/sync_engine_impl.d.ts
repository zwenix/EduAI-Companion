...
declare class SyncEngineImpl implements SyncEngine {
    ...
    queriesByTarget: Map<TargetId, Query[]>;
    /**
     ...
     * active target.
     */
    activeLimboTargetsByKey: SortedMap<DocumentKey, TargetId>;
    /**
     * Keeps track of the information about an active limbo resolution for each
     * active target ID that was started for the purpose of limbo resolution.
     */
    activeLimboResolutionsByTarget: Map<TargetId, LimboResolution>;
    ...
    limboTargetIdGenerator: TargetIdGenerator<TargetId>;
