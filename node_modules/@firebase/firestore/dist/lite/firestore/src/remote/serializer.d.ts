...
export declare function toListenRequestLabels(serializer: JsonProtoSerializer, targetData: TargetData<number>): ProtoApiClientObjectMap<string> | null;
export declare function toLabel(purpose: TargetPurpose): string | null;
export declare function toTarget(serializer: JsonProtoSerializer, targetData: TargetData<number>): ProtoTarget;
...
export declare function toPipelineValue(value: ProtoPipeline): ProtoValue;
