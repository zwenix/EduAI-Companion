import { O as _, av as n, aw as s, ax as k, g, s as x, ay as E, af as T, j as w, az as A, aA as V, aB as I, aq as R, am as $, aC as F, aD as U, aE as M, aF as N, M as L, aG as q, aH as B, w as rt, aI as H, aJ as W, aK as G, aL as K, aM as J, I as Q, C as j, J as X, f as d, e as f, k as P, i as p, aN as Y, F as h } from "./common.browser.js";
...
function __PRIVATE_selectablesToObject(e) {
    ...
    for (const n of e) {
        ...
        r = n.expr) : rt(21273, {
            selectable: n
        }), void 0 !== t[e]) throw new x("invalid-argument", `Duplicate alias or field '${e}'`);
        t[e] = r;
    }
    return t;
}
 ...
 */ class Pipeline {
    ...
    aggregate(e, ...t) {
        ...
        const n = __PRIVATE_isAliasedAggregate(e) ? {} : e, r = __PRIVATE_isAliasedAggregate(e) ? [ e, ...t ] : e.accumulators, s = __PRIVATE_isAliasedAggregate(e) ? [] : e.groups ?? [], i = function __PRIVATE_aliasedAggregateToMap(e) {
            return e.reduce(((e, t) => {
                if (void 0 !== e.get(t.alias)) throw new x("invalid-argument", `Duplicate alias or field '${t.alias}'`);
 ...
 */ function execute(e) {
    if (!e._db) return Promise.reject(new x(j.FAILED_PRECONDITION, "This pipeline was created without a database (e.g., as a subcollection pipeline) and cannot be executed directly. It can only be used as part of another pipeline."));
