...
import { ApiClientObjectMap, firestoreV1ApiClientInterfaces, Value as ProtoValue } from '../protos/firestore_proto_api';
 ...
 */
export declare class SnippetExpression extends FunctionExpression {
    /**
     * @private
     * @internal
     */
 ...
 * @returns A new {@link @firebase/firestore/pipelines#Expression} representing the parent operation.
 */
export declare function parent(documentPath: string | DocumentReference): FunctionExpression;
/**
 *
 * Creates an expression that returns the parent document reference of a document reference.
 *
 ...
 * @internal
 */
export declare function pipelineValue(pipeline: Pipeline): PipelineValueExpression;
/**
 * @internal
 */
declare class PipelineValueExpression extends Expression {
...
export declare function isAliasedExpr(val: unknown): val is AliasedExpression;
