                      ...
                      <div className="space-y-5">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <Textarea 
                            ...
                            className="h-24 text-xs rounded-xl resize-none bg-white/5 border-white/10 placeholder:text-slate-600 text-slate-300" 
                          />
                        </div>
...
// Replace until the end of the teaching tab's motion.div
